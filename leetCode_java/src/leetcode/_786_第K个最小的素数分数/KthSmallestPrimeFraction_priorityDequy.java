...
public class KthSmallestPrimeFraction_priorityDequy {
    ...
    public static void main(String[] args) {
        KthSmallestPrimeFraction_priorityDequy kthSmallestPrimeFraction = new KthSmallestPrimeFraction_priorityDequy();
